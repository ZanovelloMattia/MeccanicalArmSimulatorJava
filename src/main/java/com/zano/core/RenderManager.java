...
public class RenderManager {
    ...
    public void renderLight(Camera camera, SunLight sunLight){
        shader.setUniform("ambientLight", Consts.AMBIENT_LIGHT);
        shader.setUniform("colourLight", sunLight.getColour());
        shader.setUniform("lightPosition", sunLight.getDirection());
