...
public class Material {
    ...
    public float getReflectancePow() {
        return reflectancePow;
    }

    public void setReflectancePow(float reflectancePow) {
        this.reflectancePow = reflectancePow;
    }
}
